...
const AboutAuthor = () => {
  return (
    <div className="about__author__main">
      <div className="about__author__content">
        <div className="about__author__image-container">
          <div className="about__author__image"></div>
        </div>
